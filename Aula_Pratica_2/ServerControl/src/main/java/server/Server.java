...
public class Server {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Central server.Server ip: " + centralIp + " ,Central server.Server port:  " + centralPort);
        ...
        try{
            ...
            System.out.println("Grpc server.Server started, listening on " + svcPort);
